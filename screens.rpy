...
screen main_menu():
    ...
    imagemap:
        ground "gui/title_off_2.png"
        hover "gui/title_on_2.png"

        hotspot (0,445,410,35) clicked Start() hover_sound "audio/se/808 clav.ogg" activate_sound "audio/se/909 clav.ogg"
        # [Play("sound", "audio/se/se_start.ogg"),Pause(3.0),Start()] hover_sound "audio/se/808 clav.ogg" activate_sound "audio/se/909 clav.ogg"#(x,y,width,height)
        # hotspot (166, 637,283,696) clicked [ShowMenu("load"),Play("sound", "audio/se/se_continue_ask.ogg")] hover_sound "audio/se/808 clav.ogg" activate_sound "audio/se/909 clav.ogg"
        # hotspot (287, 637,403, 696) clicked [Hide("main_menu"),Play("sound", "audio/se/se_more.ogg"),Show("sub_nav")] hover_sound "audio/se/808 clav.ogg" activate_sound "audio/se/909 clav.ogg"
        # hotspot (410, 637, 520, 696) clicked [Play("sound", "audio/se/se_settings.ogg"),ShowMenu("preferences")] hover_sound "audio/se/808 clav.ogg" activate_sound "audio/se/909 clav.ogg"
        # hotspot (520, 637, 641, 696) clicked [Play("sound", "audio/se/se_end.ogg"),Quit(confirm=True)] hover_sound "audio/se/808 clav.ogg" activate_sound "audio/se/909 clav.ogg"
